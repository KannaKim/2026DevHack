...
export default function ClinicPage() {
  ...
  return (
    <div className="min-h-screen">
      <div
        className={`transition-all duration-500 ease-in-out flex flex-col items-center ${submittedSearch ? "pt-6" : "justify-center h-screen"}`}
      >
        {!submittedSearch && (
        ...
        <div
          className={`${submittedSearch ? "w-full max-w-6xl px-4 flex gap-6 items-center border-b border-gray-200 dark:border-gray-800 pb-6" : "w-full max-w-2xl px-4"}`}
        >
          {submittedSearch && (
            <h2
          ...
          >
            ...
            <button
              type="submit"
              className="flex items-center justify-center cursor-pointer text-blue-500 hover:text-blue-600 transition-colors ml-3 outline-none focus:outline-none"
            >
