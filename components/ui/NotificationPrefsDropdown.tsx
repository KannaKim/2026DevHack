...
export default function NotificationPrefsDropdown({ unreadCount = 0, onPrefsChange }: Props) {
  ...
  const anyChannelEnabled = useMemo(
    () => notifPrefs.emailNotifications || notifPrefs.pushNotifications || notifPrefs.smsNotifications,
    [notifPrefs]
  );
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-60">
        ...
        <DropdownMenuCheckboxItem
          ...
          onCheckedChange={(checked) => updatePref("emailNotifications", Boolean(checked))}
        >
          Email Notifications
        </DropdownMenuCheckboxItem>
        ...
        <DropdownMenuCheckboxItem
          ...
          onCheckedChange={(checked) => updatePref("pushNotifications", Boolean(checked))}
        >
        ...
        <DropdownMenuCheckboxItem
          ...
          onCheckedChange={(checked) => updatePref("smsNotifications", Boolean(checked))}
        >
          SMS Notifications
        </DropdownMenuCheckboxItem>
        ...
        <DropdownMenuGroup>
          <DropdownMenuCheckboxItem
            ...
            onCheckedChange={(checked) => updatePref("comments", Boolean(checked))}
          >
            Due Soon Vaccines
          </DropdownMenuCheckboxItem>
          ...
          <DropdownMenuCheckboxItem
            ...
            onCheckedChange={(checked) => updatePref("mentions", Boolean(checked))}
          >
            Overdue Vaccines
          </DropdownMenuCheckboxItem>
          ...
          <DropdownMenuCheckboxItem
            ...
            onCheckedChange={(checked) => updatePref("updates", Boolean(checked))}
          >
